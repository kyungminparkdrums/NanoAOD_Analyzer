...
class JetScaleResolution{
    public:
        JetScaleResolution();
        JetScaleResolution(const std::string& scaleuncertfile, const std::string& parttype, const std::string& resolutionfile, const std::string& sfresolutionfile);
        // void InitResolution(const std::string& resolutionfile, const std::string& sfuncertaintyfile);
        // void InitScale(const std::string& uncertaintyfilename, const std::string& type);
